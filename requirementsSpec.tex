...
\end{titlepage}
	...
	\section{Introduction}
        ...
        \subsection{Purpose}
        	\paragraph{To provide simple way finding around the University of Pretoria. This will be achieved through attnepting to find the shortest path possible by avoiding conjestion, traffic and catering for disabilities in a building or environment. This navigation system will also provide points of interest as well as extra features to logged in users such as preferences and a game. This application will be used by students, employees and visitors.}
    	\subsection{Scope}
