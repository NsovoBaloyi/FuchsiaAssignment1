...
\begin{minipage}{.5\textwidth}
	\centering
	%\includegraphics[width=2cm]{Map-icon-toggles}
...
\end{flushleft}
		...
		\subsubsection{Traceability Matrix}	
		{
			...
			RQ12 The system should allow the user to input their timetable and any events/activities\\
